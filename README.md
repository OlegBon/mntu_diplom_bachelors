...
- [x] Розроблено REST API з використанням **Repository Pattern** - повний **CRUD** (Create, Read, Update, Delete) для звітів.
- [x] Додано ендпоінти для **адміністрування користувачів** (створення/редагування/видалення персоналу).
- [x] **Інтелектуальне ядро:** Реалізовано модуль `Calculator` (стандарти IDC) для автоматичного визначення `Cut Grade`.
- [x] **ML Integration:** Інтегровано `MLService` для прогнозування ціни на основі параметрів.
