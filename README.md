...
- [x] **Expert Dashboard:**
  ...
  - **Advanced Filters:** Розширена панель (4C, Ціна, Дата) з анімацією.
  - Інтерактивні елементи (Посилання на ID, Дії).
...
- [ ] **Public Passport:** Сторінка перегляду сертифіката (View Report).
