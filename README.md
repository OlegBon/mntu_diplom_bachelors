...
- [x] **Dynamic Pricing:** `MLService` тепер бере базову ціну з БД **Market**, що дозволяє адміну впливати на ціноутворення.
- [x] **Market Data:** Реалізовано ендпоінти для отримання довідників (`/market/mappings`).
- [x] **Admin:** Управління персоналом (RBAC) та перегляд статистики.
