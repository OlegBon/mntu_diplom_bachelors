...
- [x] **JS Modules:** Використання Native ES Modules (без Babel).
- [x] **Pages:** Реалізовано тестову сторінку.
...
- [ ] **Login Page:** Структура та сторінка входу.
- [ ] **Auth:** Базова інтеграція з API (JWT Token в LocalStorage).
- [ ] Сторінка Дашборду (список звітів).
- [ ] Форма створення нового звіту.
- [ ] Інтеграція реальних ML-моделей (зараз емуляція).
